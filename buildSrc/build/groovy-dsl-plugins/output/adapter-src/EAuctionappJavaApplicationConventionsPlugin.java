...
/**
 * Precompiled e.auctionapp.java-application-conventions script plugin.
 **/
public class EAuctionappJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_EAuctionappJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("e.auctionapp.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_EAuctionappJavaApplicationConventions").asSubclass(BasicScript.class);
